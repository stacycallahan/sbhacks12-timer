...
### What is 6 7?
6 7 is the number 6 followed by the number 7.

## How to Use
1. Clone the repository onto your machine
   ```
   git clone https://github.com/stacycallahan/sbhacks12-timer.git
   ```
2. Run it by typing the following in your terminal
   ```
   open index.html
   ```
